...
function createBaseOnsPacketData(): OnsPacketData {
  return {
    noData: undefined
  };
}

export const OnsPacketData = {
  encode(message: OnsPacketData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OnsPacketData {
    ...
    const message = createBaseOnsPacketData();
