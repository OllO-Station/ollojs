...
export interface QueryDistributionRequest {}
export interface QueryDistributionRequestSDKType {}
export interface QueryDistributionResponse {}
...
function createBaseQueryDistributionRequest(): QueryDistributionRequest {
  return {};
}

export const QueryDistributionRequest = {
  encode(_: QueryDistributionRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryDistributionRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryDistributionRequest();
  ...
  fromPartial(_: DeepPartial<QueryDistributionRequest>): QueryDistributionRequest {
    const message = createBaseQueryDistributionRequest();
    return message;
  }
...
function createBaseQueryDistributionResponse(): QueryDistributionResponse {
  return {};
}

export const QueryDistributionResponse = {
  encode(_: QueryDistributionResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryDistributionResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryDistributionResponse();
  ...
  fromPartial(_: DeepPartial<QueryDistributionResponse>): QueryDistributionResponse {
    const message = createBaseQueryDistributionResponse();
    return message;
  }
...
function createBaseQueryLastBlockTimeRequest(): QueryLastBlockTimeRequest {
  return {};
}

export const QueryLastBlockTimeRequest = {
  encode(_: QueryLastBlockTimeRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryLastBlockTimeRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryLastBlockTimeRequest();
  ...
  fromPartial(_: DeepPartial<QueryLastBlockTimeRequest>): QueryLastBlockTimeRequest {
    const message = createBaseQueryLastBlockTimeRequest();
    return message;
  }
...
function createBaseQueryLastBlockTimeResponse(): QueryLastBlockTimeResponse {
  return {
    lastBlockTime: undefined
  };
}

export const QueryLastBlockTimeResponse = {
  encode(message: QueryLastBlockTimeResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.lastBlockTime !== undefined) {
      Timestamp.encode(toTimestamp(message.lastBlockTime), writer.uint32(10).fork()).ldelim();
    }

    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryLastBlockTimeResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryLastBlockTimeResponse();
  ...
  fromPartial(object: DeepPartial<QueryLastBlockTimeResponse>): QueryLastBlockTimeResponse {
    const message = createBaseQueryLastBlockTimeResponse();
