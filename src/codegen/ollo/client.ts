...
import * as olloLstakingV1TxRegistry from "./lstaking/v1/tx.registry";
import * as olloMarketV1TxRegistry from "./market/v1/tx.registry";
...
import * as olloLstakingV1TxAmino from "./lstaking/v1/tx.amino";
import * as olloMarketV1TxAmino from "./market/v1/tx.amino";
...
export const olloAminoConverters = { ...olloClaimV1TxAmino.AminoConverter,
  ...
  ...olloLstakingV1TxAmino.AminoConverter,
  ...olloMarketV1TxAmino.AminoConverter,
...
export const olloProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...olloClaimV1TxRegistry.registry, ...olloFarmingV1TxRegistry.registry, ...olloGrantsV1TxRegistry.registry, ...olloIncentiveV1TxRegistry.registry, ...olloLendV1TxRegistry.registry, ...olloLiquidityV1TxRegistry.registry, ...olloLockV1TxRegistry.registry, ...olloLstakingV1TxRegistry.registry, ...olloMarketV1TxRegistry.registry, ...olloNftV1TxRegistry.registry, ...olloPricesV1TxRegistry.registry, ...olloReserveV1TxRegistry.registry, ...olloTokenV1TxRegistry.registry];
