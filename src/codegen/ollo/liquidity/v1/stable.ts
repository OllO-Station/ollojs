...
function createBaseConstantProductPool(): ConstantProductPool {
  return {
    poolId: "",
    pairId: Long.UZERO,
    poolCoinDenom: "",
...
export const ConstantProductPool = {
  encode(message: ConstantProductPool, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.poolId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConstantProductPool {
    ...
    const message = createBaseConstantProductPool();
