...
function createBaseClaimPacketData(): ClaimPacketData {
  return {
    noData: undefined
  };
}

export const ClaimPacketData = {
  encode(message: ClaimPacketData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClaimPacketData {
    ...
    const message = createBaseClaimPacketData();
