...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/ollo.emissions.v1.MsgCreateRequest", MsgCreateRequest], ["/ollo.emissions.v1.MsgDepositRequest", MsgDepositRequest], ["/ollo.emissions.v1.MsgWithdrawRequest", MsgWithdrawRequest], ["/ollo.emissions.v1.MsgDrawRequest", MsgDrawRequest], ["/ollo.emissions.v1.MsgRepayRequest", MsgRepayRequest], ["/ollo.emissions.v1.MsgCloseRequest", MsgCloseRequest]];
...
export const MessageComposer = {
  encoded: {
    msgCreate(value: MsgCreateRequest) {
      return {
        typeUrl: "/ollo.emissions.v1.MsgCreateRequest",
    ...
    msgDeposit(value: MsgDepositRequest) {
      return {
        typeUrl: "/ollo.emissions.v1.MsgDepositRequest",
    ...
    msgWithdraw(value: MsgWithdrawRequest) {
      return {
        typeUrl: "/ollo.emissions.v1.MsgWithdrawRequest",
    ...
    msgDraw(value: MsgDrawRequest) {
      return {
        typeUrl: "/ollo.emissions.v1.MsgDrawRequest",
    ...
    msgRepay(value: MsgRepayRequest) {
      return {
        typeUrl: "/ollo.emissions.v1.MsgRepayRequest",
    ...
    msgClose(value: MsgCloseRequest) {
      return {
        typeUrl: "/ollo.emissions.v1.MsgCloseRequest",
