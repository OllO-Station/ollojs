...
function createBaseOraclePacketData(): OraclePacketData {
  return {
    noData: undefined
  };
}
...
export const OraclePacketData = {
  encode(message: OraclePacketData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OraclePacketData {
    ...
    const message = createBaseOraclePacketData();
