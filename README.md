...
const balance = await client.cosmos.bank.v1beta1
    .allBalances({ address: 'ollo1addresshere' });

// you can also query the ollo modules
const balances = await client.ollo.exchange.v1beta1
    .exchangeBalances()
```
...
const mnemonic =
  ...
  const chain = chains.find(({ chain_name }) => chain_name === 'ollo');
